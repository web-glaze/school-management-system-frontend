  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn("absolute inset-x-0 top-0 flex w-full items-center justify-between gap-1 pointer-events-none [&>button]:pointer-events-auto", defaultClassNames.nav),
        ...
        month_caption: cn("flex h-9 w-full items-center justify-center px-10", defaultClassNames.month_caption),
        dropdowns: cn("flex items-center justify-center gap-2", defaultClassNames.dropdowns),
        dropdown_root: cn("relative flex h-8 items-center", defaultClassNames.dropdown_root),
