  ...
  (set, get) => ({
    ...
    fetchSessions: async () => {
      try {
        ...
        const response =
          await academicService.sessions.getAll();
    ...
    createSession: async (data) => {
      try {
        await academicService.sessions.create(
          data,
        );
    ...
    updateSession: async (id, data) => {
      try {
        await academicService.sessions.update(
          id,
          data,
        );
        await get().fetchSessions();
    ...
    fetchClasses: async () => {
      try {
        ...
        const response =
          await academicService.classes.getAll();
    ...
    updateClass: async (id, data) => {
      try {
        await academicService.classes.update(
          id,
          data,
        );
        await get().fetchClasses();
    ...
    fetchSections: async () => {
      try {
        ...
        const response =
          await academicService.sections.getAll();
    ...
    updateSection: async (id, data) => {
      try {
        await academicService.sections.update(
          id,
          data,
        );
        await get().fetchSections();
