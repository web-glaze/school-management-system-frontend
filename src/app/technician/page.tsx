      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-emerald-600 via-green-500 to-lime-400 rounded-[2rem] p-10 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-5 text-lg text-white/90">
              Maintenance workforce overview.
            </p>
          </div>
        </div>
        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-[2rem] p-7 shadow-lg border">
            ...
            <h2 className="text-5xl font-bold mt-4 text-emerald-500">
              22
            </h2>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-lg border">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button className="bg-gradient-to-r from-emerald-600 to-lime-400 text-white px-5 py-3 rounded-2xl">
              Add Technician
            </button>
          </div>
