...
export default function RolesPage() {
  ...
  const createRole = async () => {
    ...
    try {
      ...
      logError("roles.page.create", error);
      notify.error(error, "Failed to create role");
    } finally {
  ...
  const deleteRole = async (role: Role) => {
    if (role.isSystem) {
      notify.error("System roles cannot be deleted");
      return;
    }
    if (
      !confirm(
    ...
    try {
      ...
      logError("roles.page.delete", error);
      notify.error(error, "Failed to delete role");
    } finally {
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-5 py-4 border-b border-border/50 hover:bg-muted/30 transition text-left"
                  >
